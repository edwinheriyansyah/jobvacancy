...

{
...

	{
		...
		if($tanggal !='' && $tanggal != '0000-00-00'){
			...
			$res = date('d',strtotime($tanggal)).'-'.date('m',strtotime($tanggal)).'-'.date('Y',strtotime($tanggal));
...
if (! function_exists('format_datepicker2'))

{

	function format_datepicker2($tanggal)
