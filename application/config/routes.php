...
$route['alur-pendaftaran'] = 'welcome/alur_pendaftaran';
$route['failed'] = 'welcome/failed';
$route['success'] = 'welcome/success';
$route['cek-email'] = 'welcome/cek_email';
$route['forgot-password'] = 'welcome/forgot_password';
$route['reset-password'] = 'welcome/reset_password';
$route['cek-forgot-password'] = 'welcome/cek_forgot_password';
$route['reset-success'] = 'welcome/reset_success';
$route['not-found'] = 'welcome/notfound';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['batal/(:any)'] = 'welcome/batal/$1';
